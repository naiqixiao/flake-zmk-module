...
west build -s zmk/app -d "/tmp/tmp.ldrWldLPWN" -b "xiao_ble" -S "studio-rpc-usb-uart" -- -DZMK_CONFIG=/tmp/zmk-config/config -DSHIELD="anywhy_flake_left" -DZMK_EXTRA_MODULES='/__w/flake-zmk-module/flake-zmk-module'
